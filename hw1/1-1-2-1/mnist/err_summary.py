...
plt.plot(row1[:,0] , row1[:,1] , label="error_table_cnn2_dim256")
plt.plot(row2[:,0] , row2[:,1] , label="error_table_cnn2_dim128_128_128")
plt.plot(row3[:,0] , row3[:,1] , label="error_table_cnn4_dim128_128_128")
plt.plot(row4[:,0] , row4[:,1] , label="error_table_residual_cnn4_dim128_128_128")
plt.legend()
plt.show()
